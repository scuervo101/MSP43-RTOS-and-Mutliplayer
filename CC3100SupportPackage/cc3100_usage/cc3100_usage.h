 ...
 */
#define HOST_IP_ADDR           0xC0A80118               // IP address of server to connect to
 ...
 */
#define CONFIG_IP       SL_IPV4_VAL(192,168,1,24)       /* Static IP to be configured */
#define AP_MASK         SL_IPV4_VAL(255,255,255,0)      /* Subnet Mask for the station */
#define AP_GATEWAY      SL_IPV4_VAL(192,168,1,13)        /* Default Gateway address */
